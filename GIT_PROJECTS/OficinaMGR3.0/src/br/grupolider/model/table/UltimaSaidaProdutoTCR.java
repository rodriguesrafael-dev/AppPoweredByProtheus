 ...
 */
public class UltimaSaidaProdutoTCR extends DefaultTableCellRenderer {

    private final JLabel c;

    public UltimaSaidaProdutoTCR() {
        c = new JLabel();
        c.setOpaque(true);
    }
    ...
    private JTable getColumnModel(JTable table) {
        ...
        columnModel.getColumn(0).setPreferredWidth(40);  //column BEM			     
        columnModel.getColumn(1).setPreferredWidth(20);  //column QUANTIDADE 
        columnModel.getColumn(2).setPreferredWidth(40);  //column UNIDADE MEDIDA
        columnModel.getColumn(3).setPreferredWidth(40);  //column CUSTO
        columnModel.getColumn(4).setPreferredWidth(40);  //column ORDEM DE SERVICO
        columnModel.getColumn(5).setPreferredWidth(70);  //column DATA ORDEM DE SERVICO
        return table;
    }
