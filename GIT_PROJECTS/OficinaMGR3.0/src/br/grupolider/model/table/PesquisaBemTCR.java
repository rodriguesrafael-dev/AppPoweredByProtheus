 ...
 */
public class PesquisaBemTCR extends DefaultTableCellRenderer {

    private final JLabel c;

    public PesquisaBemTCR() {
        c = new JLabel();
        c.setOpaque(true);
    }
    ...
    private JTable getColumnModel(JTable table) {
        ...
        columnModel.getColumn(0).setPreferredWidth(30);   //column BEM			     
        columnModel.getColumn(1).setPreferredWidth(200);  //column DESCRICAO 
        columnModel.getColumn(2).setPreferredWidth(5);    //column PLACA
        columnModel.getColumn(3).setPreferredWidth(5);    //column SERIE
        columnModel.getColumn(4).setPreferredWidth(5);    //column RENAVAM
        return table;
    }
